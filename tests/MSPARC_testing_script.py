...
# -----------------   SYSTEMS INFO   ------------------------#
################################################################################################################
SYSTEMS = { "systemname": ['BaTiO3'],
	    "Tags": [['bulk', 'lda', 'denmix', 'kerker', 'gamma', 'gamma', 'orth', 'smear_gauss','fast']],
...
SYSTEMS["Tags"].append(['surface', 'gga', 'potmix','orth','smear_fd','orient','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
SYSTEMS["systemname"].append('H2O_wire')
SYSTEMS["Tags"].append(['wire', 'lda', 'denmix', 'kerker', 'orth','smear_fd','orient','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
###############################################################################################################
SYSTEMS["systemname"].append('Si_cell_geopt')
SYSTEMS["Tags"].append(['bulk', 'gga', 'potmix', 'relax_cell','kpt','smear_fd','fast'])
SYSTEMS["Tols"].append([1e-6, 1e-5, 1e-1 ]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
###############################################################################################################
SYSTEMS["systemname"].append('Si8_atom_geopt')
SYSTEMS["Tags"].append(['bulk', 'gga', 'orth', 'denmix', 'kerker', 'relax_atom_lbfgs','gamma','smear_gauss','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'gga', 'potmix', 'nonorth','gamma','smear_fd','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'lda', 'denmix', 'orth','gamma','smear_gauss','fast'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 1]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
SYSTEMS["systemname"].append('H2O_sheet_quick')
SYSTEMS["Tags"].append(['surface', 'gga', 'potmix', 'orth','gamma','smear_fd','fast'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 1]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################						
SYSTEMS["systemname"].append('H2O_wire_quick')
SYSTEMS["Tags"].append(['wire', 'gga', 'denmix', 'orth','gamma','smear_fd','fast'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 1]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################### 
SYSTEMS["systemname"].append('SiH4_quick')
SYSTEMS["Tags"].append(['molecule', 'gga', 'denmix', 'orth','gamma','smear_gauss','fast'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 1]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
...
SYSTEMS["Tags"].append(['bulk','gga','potmix','nonorth','smear_gauss','nlcc','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
###############################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'gga', 'potmix', 'nonorth','gamma','smear_fd','nlcc','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'lda','nonorth','md_nve','kpt'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 0.5]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
SYSTEMS["systemname"].append('LiNbO2_primitive_quick_scf')
SYSTEMS["Tags"].append(['bulk', 'lda','nonorth','kpt'])
SYSTEMS["Tols"].append([1e-5, 1e-4, 0.5]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'gga', 'orth', 'gamma','vdWDF','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'spin', 'gga', 'orth', 'gamma','vdWDF','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'spin', 'nonorth', 'gamma','scan','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
...
SYSTEMS["Tags"].append(['surface', 'gga','d3','nonorth','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], 3e-4, tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
SYSTEMS["systemname"].append('NaCl_PBE0')
SYSTEMS["Tags"].append(['bulk', 'PBE0','gamma' 'nonorth','smear_fd','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
SYSTEMS["systemname"].append('O2_spin_HSE')
SYSTEMS["Tags"].append(['molecule', 'spin', 'HSE', 'denmix', 'kerker', 'orth','smear_gauss'])
SYSTEMS["Tols"].append([5e-6, tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
SYSTEMS["systemname"].append('PtAu_SOC')
SYSTEMS["Tags"].append(['bulk', 'SOC','kpt' 'nonorth','smear_gauss','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
SYSTEMS["systemname"].append('Si2_kpt_PBE0')
SYSTEMS["Tags"].append(['bulk', 'PBE0','kpt' 'nonorth','smear_fd','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
##################################################################################################################
...
SYSTEMS["Tags"].append(['bulk', 'gga', 'orth', 'denmix', 'kerker', 'relax_atom_lbfgs','gamma','smear_gauss','d3','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], tols["F_tol"], tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
SYSTEMS["systemname"].append('Si8_cell_geopt_d3')
SYSTEMS["Tags"].append(['bulk', 'gga', 'orth', 'potmix', 'relax_cell','gamma','smear_fd','d3','fast'])
SYSTEMS["Tols"].append([tols["E_tol"], 3e-4, tols["stress_tol"]]) # E_tol(Ha/atom), F_tol(Ha/Bohr), stress_tol(%)
################################################################################################################
...
def launchsystems(systems,memcheck,procs_sys,ismempbs,ifVHQ, isorient, isserial):
	...
	if True:
		...
		for syst in systems:
			...
			samplePBS_content.append('''matlab -nodisplay -nodesktop -r 'launch_'''+syst+"' > "+syst +".log")
			if isorient[count] == False:
				os.chdir("temp_run")
				f_launch = open("launch_"+syst+".m","w")
				f_launch.write(launch_text)
				f_launch.close()
			...
			for ll in range(len(sys_grp)):
				if memcheck_grp[ll] == False:
					...
					if orient_grp[ll] == False:
						...
						samplePBS_content.append("matlab -nodisplay -nodesktop -r msparc('./"+sys_grp[ll]+"/temp_run/"+sys_grp[ll]+"')  > "+sys_grp[ll] +".log")
						samplePBS_content.append("\n")
					else:
						samplePBS_content.append("matlab -nodisplay -nodesktop -r msparc('./"+sys_grp[ll]+"/temp_run1/"+sys_grp[ll]+"')  > "+sys_grp[ll] +".log")
						samplePBS_content.append("\n")
						samplePBS_content.append("matlab -nodisplay -nodesktop -r msparc('./"+sys_grp[ll]+"/temp_run2/"+sys_grp[ll]+"')  > "+sys_grp[ll] +".log")
						samplePBS_content.append("\n")
						samplePBS_content.append("matlab -nodisplay -nodesktop -r msparc('./"+sys_grp[ll]+"/temp_run3/"+sys_grp[ll]+"')  > "+sys_grp[ll] +".log")
						samplePBS_content.append("\n")
				else:
					if orient_grp[ll] == False:
		...
		if info_out["isPrintF"] == True:
			if lines == 'Atomic forces (Ha/Bohr):':
				...
				for i in range(info_out["no_atoms"]):
					...
					if re.findall(r'\b[+-]?[0-9]+\.[0-9]+E[+-]?[0-9]+\b',line_temp) == []:
	...
	for lines in f_geopt_content:
		...
		if info_out["isPrintAtoms"] == True:
			if lines == ':R:' or lines ==':R(Bohr):':
				...
				for i in range(info_out["no_atoms"]):
					line_temp = f_geopt_content[index+i+1]
					if re.findall(r'\b[+-]?[0-9]+\.[0-9]+\b',line_temp) == []:
						pos_atom_temp =  re.findall(r'\b[+-]?[0-9]+\.[0-9]+E[+-]?[0-9]+\b',line_temp)
					else:
...
def ReadAimdFile(filepath, info_out):
	...
	for lines in f_aimd_content:
		if re.findall(r':TE:',lines) == [':TE:']:
			m = re.findall(r'\b[+-]?\d+\.\d+E[+-]\d+\b',lines)
			ken_temp = float(m[0])
			KEN.append(ken_temp)
		if info_out["isPrintF"] == True:
			if lines == ':F:':
		...
		if ifref == False:
			...
			if isorientsys == False:
				if ifVHQ == True:
					...
					infgeopt = ReadGeoptFile("./standard/"+syst+".refcellopt", infout)
			else:
				if ifVHQ == True:
					...
					infgeopt = ReadGeoptFile("./standard_orientation1/"+syst+".refcellopt", infout)
...
def WriteReport(data_info, systems, isparallel, ifVHQ, isorient):
	...
	for i in range(len(systems)):
		...
		if info_run["Type"]=="singlept":
			...
			Failure_text=""
			if (Error_SCF_no <=  scfno_tol and errspin <= spin_tol  and E_sys_err <= E_tol and force_error <= F_tol and stress_error <= stress_tol ):
			...
			text = text+text1+text2+text3
			Failure_text=""
			if (Error_SCF_no <=  scfno_tol and errspin <= spin_tol  and E_sys_err <= E_tol  and cell_error <= CELL_tol):
				test_status.append("passed")
				text="Test Result: Passed \n"+text
			else:
				Failure_text = Failure_text+"Test for this system "+" failed in: "
			...
			text = text+text1+text2+text3
			Failure_text = ""
			if (Error_SCF_no <=  scfno_tol and errspin <= spin_tol  and E_err <= E_tol and cell_error <= CELL_tol  and scfpos_err <= scfpos_tol):
				test_status.append("passed")
				text="Test Result: Passed \n"+text
			else:
				Failure_text = Failure_text+"Test for this system "+" failed in: "
			...
			if len(info_run["energy"]) != len(info_ref["energy"]):
				...
				text = text+text1+text2+text3
				Failure_text=""
				if (Error_SCF_no <=  scfno_tol and errspin <= spin_tol  and E_sys_err <= E_tol   and max_KENerror <= KEN_tol  and maxF_err <= F_tol):
					test_status.append("passed")
					text="Test Result: Passed \n"+text
				else:
					Failure_text = Failure_text+"Test for this system "+" failed in: "
	...
	if is_update_reference:
		...
		for systs in systems:
			...
			if 'orient' in tags_sys[index_count]:
				...
				elif ((Type[index_count] == "relax_atom") or  (Type[index_count] == "relax_total")):
					os.system("cp temp_run1/"+systs+".out "+accuracy_text+"_orientation1/"+systs+".refout")
				...
				elif ((Type[index_count] == "relax_cell")):
					os.system("cp temp_run1/"+systs+".out "+accuracy_text+"_orientation1/"+systs+".refout")
					os.system("cp temp_run1/"+systs+".cellopt "+accuracy_text+"_orientation1/"+systs+".refcellopt")
					os.system("cp temp_run2/"+systs+".out "+accuracy_text+"_orientation2/"+systs+".refout")
					os.system("cp temp_run2/"+systs+".cellopt "+accuracy_text+"_orientation2/"+systs+".refcellopt")
					os.system("cp temp_run3/"+systs+".out "+accuracy_text+"_orientation3/"+systs+".refout")
					os.system("cp temp_run3/"+systs+".cellopt "+accuracy_text+"_orientation3/"+systs+".refcellopt")
				...
				if Type[index_count] == "None":
					...
					os.system("cp temp_run/"+systs+".out "+accuracy_text+"/"+systs+".refout")
					os.system("cp temp_run/"+systs+".cellopt "+accuracy_text+"/"+systs+".refcellopt")
